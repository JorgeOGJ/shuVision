namespace AForge.Video.DirectShow
{
    partial class VideoCaptureDeviceForm
    {
        ...
        private void InitializeComponent( )
        {
        	...
        	this.groupBox1.Text = "Ajustes del dispositivo de Captura";
        	// 
        	// videoInputsCombo
        	// 
        	...
        	this.label3.Text = "Entrada de Video";
        	// 
        	// snapshotsLabel
        	// 
        	...
        	this.snapshotsLabel.Size = new System.Drawing.Size(123, 13);
        	this.snapshotsLabel.TabIndex = 15;
        	this.snapshotsLabel.Text = "Resolucion de Snapshot";
        	// 
        	...
        	this.label1.Text = "Dispositivo de Video";
        	// 
        	// pictureBox
        	// 
        	...
        	this.Text = "Abrir dispositivo local de captura";
